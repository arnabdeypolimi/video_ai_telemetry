"""Structured log API for avatar-otel.
...
# Set by _init_logging() during avatar_otel.init().  None = before init.
...
def _init_logging(
    ...
    """Called once during avatar_otel.init() to wire up the module-level logger.
...
# module at the top level — callers use avatar_otel.trace, not this module directly).
